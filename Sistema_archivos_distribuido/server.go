...
var (
	...
	selfAddr         string
	// Nuevo mapa para rastrear copias locales para edición
	localWorkUnitsMutex sync.RWMutex
	localWorkUnits      = make(map[string]string) // key: filename, value: originalOwnerIP
)
