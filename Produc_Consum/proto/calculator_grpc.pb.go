...
type CalculatorClient interface {
	...
	Evaluate(ctx context.Context, in *Expression, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *calculatorClient) Evaluate(ctx context.Context, in *Expression, opts ...grpc.CallOption) (*Result, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Result)
	err := c.cc.Invoke(ctx, Calculator_Evaluate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServer interface {
	// Función única pública que evalúa expresiones matemáticas
	Evaluate(context.Context, *Expression) (*Result, error)
...
func (UnimplementedCalculatorServer) Evaluate(context.Context, *Expression) (*Result, error) {
